...
RUN_ROOT="$ROOT/outputs/text_gs_b32_recovery_sweep_20260830"
...
launch_variant() {
  local gpu="$1" tag="$2" recovery_weight="$3"
...
launch_variant 0 recovery_q015 0.15
launch_variant 1 recovery_q030 0.30
launch_variant 2 recovery_q045 0.45
