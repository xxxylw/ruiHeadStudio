...
RUN_ROOT="$ROOT/outputs/text_gs_b32_recovery_fast_sweep_20260830"
OLD_ROOT="$ROOT/outputs/text_gs_b32_recovery_sweep_20260830"
...
launch_variant() {
  local gpu="$1" tag="$2" recovery_weight="$3" base_ply="$4"
  ...
  CUDA_VISIBLE_DEVICES="$gpu" nohup python3 launch.py --config configs/headstudio_retry.yaml --train \
    ...
    "trainer.max_steps=600" "data.batch_size=1" "system.gaussian_init_ply=$base_ply" \
    "system.gaussian_init_step=18500" "system.clip_start_step=18500" \
    ...
    "system.lambda_reference_statistics=0.001" \
...
launch_variant 0 recovery_fast_q015 0.15 "$OLD_ROOT/recovery_q015/runs/recovery_q015/save/last.ply"
launch_variant 1 recovery_fast_q030 0.30 "$OLD_ROOT/recovery_q030/runs/recovery_q030/save/last.ply"
launch_variant 2 recovery_fast_q045 0.45 "$OLD_ROOT/recovery_q045/runs/recovery_q045/save/last.ply"
