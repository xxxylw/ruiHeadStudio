...
RUN_ROOT="$ROOT/outputs/text_gs_b32_stats_tail_sweep_20260830"
...
launch_variant() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu" nohup python3 launch.py --config configs/headstudio_retry.yaml --train \
    ...
    "system.gaussian_init_step=19100" "system.clip_start_step=19100" \
    "system.clip_decay_start_step=19500" "system.clip_decay_end_step=20000" \
    "system.quality_start_step=19100" "system.quality_ramp_end_step=19600" \
...
launch_variant 0 stats_tail_q0002 0.0002 recovery_fast_q015
launch_variant 1 stats_tail_q0005 0.0005 recovery_fast_q045
launch_variant 2 stats_tail_q0010 0.0010 recovery_fast_q030
