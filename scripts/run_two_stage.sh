...
IDENTITY_AWARE_STAGE1_ENABLED="${IDENTITY_AWARE_STAGE1_ENABLED:-true}"
if [[ "${IDENTITY_AWARE_STAGE1_ENABLED}" == "true" ]]; then
...
STAGE1_LAMBDA_SPARSITY="${STAGE1_LAMBDA_SPARSITY}" \
STAGE1_LAMBDA_OPAQUE="${STAGE1_LAMBDA_OPAQUE}" \
...
STAGE2_LAMBDA_SPARSITY="${STAGE2_LAMBDA_SPARSITY}" \
STAGE2_LAMBDA_OPAQUE="${STAGE2_LAMBDA_OPAQUE}" \
