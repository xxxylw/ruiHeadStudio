...
RUN_ROOT="$ROOT/outputs/text_gs_alignment_frequency_quality_sweep_20260830"
...
launch_variant() {
  ...
  CUDA_VISIBLE_DEVICES="$gpu" nohup python3 launch.py \
    ...
    "system.quality_start_step=11000" "system.quality_ramp_end_step=12000" \
    "system.max_grad=0.0005" "system.area_relax=True" \
    "system.loss.lambda_clip=0.001" "system.lambda_frequency_quality=$lambda_quality" \
...
launch_variant 0 frequency_q0005 0.0005
launch_variant 1 frequency_q0010 0.0010
launch_variant 2 frequency_q0020 0.0020
