...
set -u
export HF_HUB_OFFLINE=1 DIFFUSERS_OFFLINE=1 TRANSFORMERS_OFFLINE=1 HEADSTUDIO_FINAL_STEP=20000

for tag in reference_q001 reference_q003 reference_q006; do
  out="$RUN_ROOT/$tag"
