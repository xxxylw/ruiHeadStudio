...
BASE_PLY="$ROOT/outputs/text_gs_alignment_prompt_factorization_sweep_20260830/content/runs/content/save/last.ply"
...
launch_variant() {
  local gpu="$1" tag="$2" lambda_quality="$3"
  ...
  CUDA_VISIBLE_DEVICES="$gpu" nohup python3 launch.py --config configs/headstudio_retry.yaml --train \
    ...
    "system.gaussian_init_step=16000" "system.clip_start_step=16000" \
    "system.clip_decay_start_step=17000" "system.clip_decay_end_step=18000" \
    "system.quality_start_step=17000" "system.quality_ramp_end_step=18000" \
    "system.max_grad=0.0005" "system.area_relax=True" "system.loss.lambda_clip=0.0005" \
    "system.lambda_frequency_quality=$lambda_quality" "system.clip_global_weight=0.50" \
...
launch_variant 0 content_q0010 0.0010
launch_variant 1 content_q0020 0.0020
launch_variant 2 content_q0040 0.0040
